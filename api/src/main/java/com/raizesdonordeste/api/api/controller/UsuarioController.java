...
import com.raizesdonordeste.api.application.UsuarioService;
...
public class UsuarioController {
    ...
    public ResponseEntity<Page<UsuarioResponseDTO>> listarTodos(
        ...
        Pageable pegeable = PageRequest.of(page, size, Sort.by("id").ascending()); 
        Page<UsuarioResponseDTO> usuarios = usuarioService.listarTodos(pegeable);
