...
import com.raizesdonordeste.api.api.dto.UsuarioRequestDTO;
import com.raizesdonordeste.api.api.dto.UsuarioResponseDTO;
import com.raizesdonordeste.api.api.dto.UsuarioUpdateDTO;
import com.raizesdonordeste.api.application.exception.CadastroDuplicadoException;
...
import com.raizesdonordeste.api.infrastructure.repository.PerfilRepository;
...
public class UsuarioService {
    ...
    public Page<UsuarioResponseDTO> listarTodos(Pageable pegeable){
        Page<Usuario> usuarios = usuarioRepository.findAll(pegeable);
        Page<UsuarioResponseDTO> usuariosDTO = usuarios.map(u -> UsuarioResponseDTO.fromEntity(u));
